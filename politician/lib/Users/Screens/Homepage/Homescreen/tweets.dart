...
import 'package:politician/Users/Services/twitter.dart';
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text("Mr XYZ",
                                textScaleFactor: 1,
                                style: TextStyle(color: Colors.black,fontSize: 16,fontFamily: 'Montserrat',fontWeight: FontWeight.w400),),
                          ...
                          Padding(
                            padding: const EdgeInsets.fromLTRB(10,0,0,0),
                            child: Text("${tweets[index].favoriteCount.toString()} Likes  ${tweets[index].retweetCount.toString()} Retweet",
                              textScaleFactor: 1,
