...
class mainhome extends StatefulWidget {
  ...
  @override
  _mainhomeState createState() => _mainhomeState(prefskylo:prefskylo);
}

class _mainhomeState extends State<mainhome> {
  SharedPreferences prefskylo;
  _mainhomeState({required this.prefskylo});
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  post==true ? posts(context,ref3,prefskylo) : tweets(context),
